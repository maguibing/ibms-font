  ...
  namespace I18n {
    ...
    type Schema = {
      ...
      deviceList: {
        ...
        currentTypePlaceholder: string;
        createSettings: string;
        batchAdd: string;
        customAdd: string;
        addCount: string;
        addCountPlaceholder: string;
        addCountInvalid: string;
        keyStart: string;
        keyStartPlaceholder: string;
        keyStartInvalid: string;
        identifierPreview: string;
        previewHint: string;
        customIdentifier: string;
        customIdentifierPlaceholder: string;
        description: string;
      ...
      deviceDetail: {
        ...
        updatedAt: string;
        logicPoints: string;
        logicPointName: string;
        logicPointIdentifier: string;
        logicPointNamePlaceholder: string;
        logicPointIdentifierPlaceholder: string;
        dataType: string;
        alarms: string;
        workOrders: string;
        tasks: string;
      ...
      deviceTypeDetail: {
        ...
        pointIdentifierPlaceholder: string;
        dataType: string;
        pointList: string;
        import: string;
        pointFilePrefix: string;
        pointTaskName: string;
        addPoint: string;
        editPoint: string;
        missingDeviceTypeId: string;
        missingPointId: string;
      };
      devicePointManage: Record<string, string>;
      deviceType: {
        management: string;
        name: string;
        identifier: string;
      ...
      gatewayList: {
        ...
        httpClientProtocol: string;
        modbusProtocol: string;
        bacnetProtocol: string;
        opcUaProtocol: string;
        dataFormat: string;
        dataFormatPlaceholder: string;
        namePlaceholder: string;
        topicPlaceholder: string;
        identifierPlaceholder: string;
        protocolPlaceholder: string;
        modbusTcpParameters: string;
        ipAddress: string;
        ipAddressPlaceholder: string;
        portPlaceholder: string;
        pollIntervalSeconds: string;
        pollIntervalSecondsPlaceholder: string;
        timeoutSeconds: string;
        timeoutSecondsPlaceholder: string;
        bacnetIpParameters: string;
        targetAddress: string;
        targetAddressPlaceholder: string;
        targetPort: string;
        targetPortPlaceholder: string;
        opcUaConnectionParameters: string;
        opcUaEndpointPlaceholder: string;
        securityMode: string;
        securityModePlaceholder: string;
        securityPolicyUri: string;
        securityPolicyUriPlaceholder: string;
        authType: string;
        authTypePlaceholder: string;
        usernamePlaceholder: string;
        passwordPlaceholder: string;
        serverAddressPlaceholder: string;
        requestTimeoutSecondsPlaceholder: string;
        sessionTimeoutSeconds: string;
        sessionTimeoutSecondsPlaceholder: string;
        connectionTimeoutSeconds: string;
        connectionTimeoutSecondsPlaceholder: string;
        invalidIpAddress: string;
        tokenRequestIncomplete: string;
        requestHeadersIncomplete: string;
        requestBodyIncomplete: string;
        pollingRouteIncomplete: string;
        routeGroupIncomplete: string;
        routeGroupRequired: string;
        tokenFieldRequiredWhenAuthEnabled: string;
        tokenFieldRequiredWhenAuthDisabled: string;
        selectTokenPlacement: string;
        autoFillTokenKeyPlaceholder: string;
        spacePlaceholder: string;
        descriptionPlaceholder: string;
        dynamicTokenAuth: string;
        tokenRequest: string;
        contentType: string;
        tokenFieldName: string;
        expireFieldName: string;
        expireSeconds: string;
        expireSecondsPlaceholder: string;
        deviceBehaviorRoute: string;
        supportCommandSend: string;
        pollingPull: string;
        requestMethodAndPath: string;
        withAuth: string;
        ...
        tokenRequestPath: string;
        pollRequestMethod: string;
        pollRequestPath: string;
        pollAuth: string;
        pollTokenPlacement: string;
        pollTokenField: string;
        sendRequestMethod: string;
        sendRequestPath: string;
        sendAuth: string;
        sendTokenPlacement: string;
        sendTokenField: string;
        localAddress: string;
        autoDiscovery: string;
        subscription: string;
        protocolConfigEmpty: string;
        gatewayDetailEmpty: string;
      };
      deviceGroup: {
        management: string;
        name: string;
      ...
      virtualPoint: {
        ...
        drawer: {
          ...
          key: string;
          belongDevice: string;
          belongDevicePlaceholder: string;
          status: string;
          storageHistory: string;
          validTimeRange: string;
          computeMode: string;
          configuration: string;
          settingJsonPlaceholder: string;
        };
        validation: {
          name: string;
          key: string;
          belongDevice: string;
          validTimeRangeRequired: string;
          validTimeRangeInvalid: string;
          formulaRequired: string;
          settingJsonInvalid: string;
          formulaFailed: string;
          switchMappingIncomplete: string;
          enumMappingIncomplete: string;
        ...
        history: {
          ...
          missingPhysicalPointKey: string;
          fetchFailed: string;
        };
        setting: {
          title: string;
          ...
          trueAlias: string;
          trueAliasPlaceholder: string;
          falseAlias: string;
          falseAliasPlaceholder: string;
          enumMapping: string;
          enumValue: string;
        ...
        formula: {
          ...
          validateSuccessWithResult: string;
          clear: string;
          clearConfirm: string;
          noContent: string;
          pointSource: string;
          selectDevice: string;
          searchPoint: string;
          noDigitalPoint: string;
          keyboard: string;
        };
        formulaErrors: {
          invalidNumber: string;
          functionAfterParen: string;
          twoValuesNeedOperator: string;
          rightParenBeforeValue: string;
          parenMismatch: string;
          consecutiveOperator: string;
          logicalNotPosition: string;
          operatorAtStart: string;
          operatorBeforeValue: string;
          invalidContent: string;
          empty: string;
          operatorAtEnd: string;
          openParenAfterFunction: string;
          openParenAtEnd: string;
          unsupportedContent: string;
          ternaryMismatch: string;
        };
        segmentMapping: {
          matchSource: string;
          sourceType: string;
          initialPoint: string;
          expression: string;
          enableDefaultOutput: string;
          rules: string;
          addRule: string;
          minValue: string;
          maxValue: string;
          bound: string;
          boundLeftClosedRightOpen: string;
          boundClosedInterval: string;
          boundOpenInterval: string;
          boundLeftOpenRightClosed: string;
          outputValue: string;
          remark: string;
          deleteRule: string;
          device: string;
          ...
          selectInitialPoint: string;
          completeRules: string;
          defaultOutputRequired: string;
        };
        thresholdAssign: {
          deviceSourceType: string;
          action: string;
          accumulateType: string;
          immediateAssign: string;
          window: string;
          assignRules: string;
          addRule: string;
          repeatTimes: string;
          ...
          assignValue: string;
          deleteRule: string;
          validationRulesRequired: string;
          device: string;
          devicePlaceholder: string;
          deviceType: string;
          ...
          validationRepeatTimes: string;
          validationRepeatTimesDuplicate: string;
          validationDuration: string;
          validationDurationDuplicate: string;
          validationDurationExceedsWindow: string;
        };
        statisticalCount: {
          deviceSourceType: string;
          settings: string;
          ...
          placeholder: string;
          validationAccumulateValue: string;
        };
      };
      energy: {
        list: string;
