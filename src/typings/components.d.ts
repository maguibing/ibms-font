...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IconMaterialSymbolsImageNotSupportedOutlineRounded: typeof import('~icons/material-symbols/image-not-supported-outline-rounded')['default']
...
declare global {
  ...
  const IconMaterialSymbolsImageNotSupportedOutlineRounded: typeof import('~icons/material-symbols/image-not-supported-outline-rounded')['default']
