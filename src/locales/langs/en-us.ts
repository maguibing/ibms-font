const local: App.I18n.Schema = {
  ...
  cockpit: {
    title: 'Cockpit',
    noAvailable: 'No dashboard is available to enter'
  },
  systemLog: {
    title: 'System Logs',
  ...
  deviceList: {
    ...
    list: 'Device List',
    noData: 'No devices',
    namePlaceholder: 'Please enter a device name',
    identifierPlaceholder: 'Please enter a device identifier',
    typePlaceholder: 'Please select a device type',
    groupPlaceholder: 'Please select a device group',
    statusPlaceholder: 'Please select a status',
    add: 'Create Device',
    edit: 'Edit Device',
    space: 'Space',
    spacePlaceholder: 'Please select a space',
    currentTypePlaceholder: 'Current device type',
    createSettings: 'Creation Settings',
    batchAdd: 'Batch Add',
    customAdd: 'Custom Add',
    addCount: 'Add Count',
    addCountPlaceholder: 'Please enter the add count',
    addCountInvalid: 'Add count must be greater than 0',
    keyStart: 'Identifier Start',
    keyStartPlaceholder: 'Please enter the identifier start',
    keyStartInvalid: 'Identifier start must contain only numbers',
    identifierPreview: 'Identifier Preview',
    previewHint: 'Complete the identifier start and add count',
    customIdentifier: 'Custom Identifier',
    customIdentifierPlaceholder: 'Please enter a custom identifier',
  ...
  deviceDetail: {
    ...
    updatedAt: 'Updated At',
    logicPoints: 'Logic Points',
    logicPointName: 'Point Name',
    logicPointIdentifier: 'Point Identifier',
    logicPointNamePlaceholder: 'Please enter a point name',
    logicPointIdentifierPlaceholder: 'Please enter a point identifier',
    dataType: 'Data Type',
    alarms: 'Alarms',
  ...
  deviceTypeDetail: {
    ...
    pointNamePlaceholder: 'Please enter a point name',
    pointIdentifierPlaceholder: 'Please enter a point identifier',
    dataType: 'Data Type',
    pointList: 'Point List',
    import: 'Import',
    pointFilePrefix: 'Device Type Points',
    pointTaskName: 'Device Type Points',
    addPoint: 'Add Point',
    editPoint: 'Edit Point',
    missingDeviceTypeId: 'Device type ID is missing',
    missingPointId: 'Point ID is missing'
  },
  devicePointManage: {
    gateway: 'Gateway',
    deviceType: 'Device Type',
    ...
    noLogicPointTree: 'No logic point tree',
    protocol: 'Protocol',
    name: 'Name',
    identifier: 'Identifier',
    ...
    logicPoint: 'Logic Point',
    physicalPoint: 'Physical Point',
    notBound: 'Not Bound',
    websocketWarning: 'WebSocket is not connected. Please try again later',
    ...
    pointNamePlaceholder: 'Please enter a point name',
    pointIdentifierPlaceholder: 'Please enter a point identifier',
    dataTypePlaceholder: 'Please select a data type',
    import: 'Import',
    scanPoints: 'Scan Points',
    scanPointsHint: 'Click Scan Points to get results',
    noPoints: 'No points',
    device: 'Device',
    logicPointName: 'Logic Point Name',
    logicPointIdentifier: 'Logic Point Identifier',
    physicalPointNotFound: 'Physical point not found',
    bindPhysicalPoint: 'Bind Physical Point',
    viewPhysicalPoint: 'View Physical Point',
    unbindPhysicalPoint: 'Unbind Physical Point',
    unbindConfirm: 'Unbind this physical point?',
    smartMatch: 'Smart Match',
    smartMatchSuccess: 'Smart match succeeded',
    unbindSuccess: 'Unbound successfully',
    importMapping: 'Import Mapping',
    mappingFilePrefix: 'Point Mapping',
    mappingTaskName: 'Point Mapping',
    selectPhysicalPoint: 'Select Physical Point',
    select: 'Select',
    selected: 'Selected',
    physicalPointRequired: 'Please select a physical point',
    bindSuccess: 'Bound successfully',
    gatewayPlaceholder: 'Please select a gateway',
    devicePlaceholder: 'Please select a device',
    logicPointPlaceholder: 'Please select a logic point',
    commandTitle: 'Point Command',
    identifierSuffix: ' Identifier',
    commandValue: 'Command Value',
    commandValueInput: 'Please enter a command value',
    commandValueSelect: 'Please select a command value',
    commandUnsupported: 'No command options',
    commandUnsupportedType: 'This data type is not supported',
    confirmCommand: 'Confirm Command',
    commandSuccess: 'Command sent successfully',
    on: 'On',
    off: 'Off',
    modbusParameters: 'Modbus Parameters',
    bacnetParameters: 'BACnet Parameters',
    opcUaParameters: 'OPC UA Parameters',
    slaveAddress: 'Slave Address',
    slaveAddressPlaceholder: 'Please enter a slave address',
    registerAddress: 'Register Address',
    registerAddressPlaceholder: 'Please enter a register address',
    registerType: 'Register Type',
    registerTypePlaceholder: 'Please select a register type',
    bitIndex: 'Bit Index',
    byteOrder: 'Byte Order',
    byteOrderPlaceholder: 'Please select byte order',
    objectType: 'Object Type',
    objectTypePlaceholder: 'Please select an object type',
    deviceInstance: 'Device Instance',
    objectInstance: 'Object Instance',
    nodeId: 'Node ID',
    nodeIdPlaceholder: 'Please enter a node ID',
    accessLevelPlaceholder: 'Please select an access level',
    objectInstancePlaceholder: 'Please enter an object instance',
    storage: 'Store Value',
    linearTransform: 'Linear Transform',
    linearTransformHint: 'Convert range 85-170 to 0-1',
    optionalDevice: 'Device (Optional)',
    scale: 'Scale',
    offset: 'Offset',
    addPhysicalPoint: 'Add Physical Point',
    editPhysicalPoint: 'Edit Physical Point',
    deviceList: 'Device List',
    deviceCount: '{count} devices',
    deviceSearchPlaceholder: 'Search device name, address, or instance',
    noMatchingDevices: 'No matching devices',
    addressWithValue: 'Address: {value}',
    deviceInstanceWithValue: 'Device Instance: {value}',
    slaveAddressWithValue: 'Slave Address: {value}',
    nodeIdWithValue: 'Node ID: {value}',
    selectDevice: 'Please select a device',
    rescanPoints: 'Rescan Points',
    pointScanParameters: 'Point Scan Parameters',
    startRegisterAddress: 'Start Register Address',
    pointCount: '{count} points',
    maxPointsPerNode: 'Max Points per Node',
    maxDepth: 'Max Depth',
    pointList: 'Point List',
    startSlaveAddress: 'Start Slave Address',
    endSlaveAddress: 'End Slave Address',
    startSlaveAddressPlaceholder: 'Please enter a start slave address',
    endSlaveAddressPlaceholder: 'Please enter an end slave address',
    maxDevices: 'Max Devices',
    maxDepthPlaceholder: 'Please enter max depth',
    maxDevicesPlaceholder: 'Please enter max devices',
    localInterface: 'Local Interface',
    timeoutSeconds: 'Timeout (seconds)',
    noScanParameters: 'No scan parameters for the current protocol',
    scanResults: 'Scan Results',
    selectGatewayToScan: 'Select a gateway to start scanning',
    noScannedDevices: 'No scanned devices',
    scanDevices: 'Scan Devices',
    scanParameters: 'Scan Parameters',
    exportPoints: 'Export Points',
    invalidStartRegisterAddress: 'Please enter a valid start register address',
    invalidPointCount: 'Please enter a valid point count',
    invalidMaxPointsPerNode: 'Please enter a valid max points per node',
    missingSlaveAddress: 'Slave address is missing',
    missingNodeId: 'Node ID is missing',
    scanPointsFailed: 'Point scan failed',
    scanPointsSuccess: 'Points scanned successfully',
    protocolScanUnsupported: 'The current protocol does not support scanning',
    validGatewayRequired: 'Please select a valid gateway',
    scanDevicesSuccess: 'Devices scanned successfully',
    scanPointsFirst: 'Please scan points first',
    gatewayDetailFailed: 'Failed to fetch gateway details',
    notScanned: 'Not scanned',
    deviceWithIndex: 'Device {index}',
    modbusCoil: '1-Coil Register',
    modbusDiscrete: '2-Discrete Register',
    modbusHolding: '3-Holding Register',
    modbusInput: '4-Input Register',
  ...
  deviceType: {
    ...
    createdAt: 'Created At',
    view: 'View',
    noData: 'No device types',
    namePlaceholder: 'Please enter a device type name',
    identifierPlaceholder: 'Please enter a device type identifier',
    statusPlaceholder: 'Please select a status',
    add: 'Create Device Type',
    edit: 'Edit Device Type',
    customCreate: 'Custom Create',
    importFromTemplate: 'Import from Template Library',
    description: 'Description',
    descriptionPlaceholder: 'Please enter a description',
    enabled: 'Enabled',
    disabled: 'Disabled',
    templateTitle: 'Device Type Templates',
    categoryPlaceholder: 'Please select a template category',
    noTemplates: 'No device type templates',
    noCategory: 'No category selected',
    templateCount: '{count} templates',
    templateRequired: 'Please select a device type template',
    pointRequired: 'Please select at least one point',
    pointName: 'Point Name',
    pointIdentifier: 'Point Identifier',
    dataType: 'Data Type',
  ...
  effroom: {
    ...
    statisticMethod: 'Statistic Method',
    query: 'Query',
    ...
    pointCompare: 'Point Comparison',
    pointSearchPlaceholder: 'Search point name or identifier',
    noSelectablePoints: 'No selectable points',
    selectPointsHint: 'Select points to compare from the left',
    ...
    time: 'Time',
    maxPoints: 'Select up to {count} points',
    trendFetchFailed: 'Failed to fetch point trend data',
    noDataForCondition: 'No data for current conditions',
    websocketWarning: 'WebSocket is not connected. Please try again later',
    exportSubmitted: 'Export task submitted',
    finestGranularity: 'Already at the finest granularity',
    calendar: 'Efficiency Calendar',
    energy: 'Energy',
    cooling: 'Cooling',
  ...
  ledger: {
    ...
    assetsTypeManagement: 'Asset Type Management',
    ...
    noQr: 'No downloadable QR codes in the current list',
    downloadStarted: 'Started downloading {count} QR codes',
    wsWarning: 'WebSocket is not connected. Please try again later',
    exportSubmitted: 'Export task submitted',
    exportName: 'Ledger Assets',
    qrAlt: 'Asset QR code',
    viewAssets: 'View Asset',
    basicInfo: 'Basic Information',
    assetsId: 'Asset ID',
    projectId: 'Project ID',
    updatedAt: 'Updated At',
    belongDevice: 'Related Device',
    attribution: 'Attribution',
    location: 'Location',
    owner: 'Owner',
    procurement: 'Procurement Information',
    purchaseAt: 'Purchase Date',
    supplier: 'Supplier',
    expireAt: 'Expiration Date',
    expireNotice: 'Expiration Notice',
    remark: 'Remark',
    noAssets: 'No asset data',
    addAssets: 'Add Asset',
    editAssets: 'Edit Asset',
    addAssetsType: 'Add Asset Type',
    editAssetsType: 'Edit Asset Type',
    assetsTypeName: 'Asset Type Name',
    status: 'Status',
    desc: 'Description',
    enabled: 'Enabled',
    disabled: 'Disabled',
    selectStatus: 'Please select asset status',
    select: 'Please select',
    input: 'Please enter',
    selectAssetsType: 'Please select asset type',
    selectDept: 'Please select department',
    selectDevice: 'Please select device',
    selectDate: 'Please select creation time',
    inputLocation: 'Please enter location',
    inputOwner: 'Please enter owner',
    inputPrice: 'Please enter purchase price',
    inputSupplier: 'Please enter supplier',
    inputNotice: 'Please enter notice days',
    inputDesc: 'Please enter description',
    inputRemark: 'Please enter remark',
    searchAssetsNo: 'Please enter asset number',
    searchAssetsName: 'Please enter asset name',
    qrTaskName: 'Ledger Assets',
    typeName: 'Please enter asset type name',
    noData: 'No data'
  },
  gatewayList: {
    name: 'Gateway Name',
    ...
    list: 'Gateway List',
    noData: 'No gateways',
    searchName: 'Please enter gateway name',
    searchProtocol: 'Please select protocol type',
    identifierLabel: 'Identifier',
    protocol: 'Protocol',
    enabled: 'Enabled',
    disabled: 'Disabled',
    ...
    add: 'Add Gateway',
    edit: 'Edit Gateway',
    detailFetchFailed: 'Failed to fetch gateway details',
    ...
    host: 'Host',
    port: 'Port',
    mqttConfig: 'MQTT Reporting Configuration',
    reportAddress: 'Report Address',
    bearerToken: 'Standard Authorization Header (Bearer Token)',
    rawToken: 'Standard Authorization Header (Raw Token)',
    headerToken: 'Custom Request Header (Header)',
    queryToken: 'URL Query Parameter (Query)',
    bodyToken: 'Request Body Parameter (Body)',
    ...
    mqttProtocol: 'MQTT',
    httpServerProtocol: 'HTTP Server',
    httpClientProtocol: 'HTTP Client',
    modbusProtocol: 'Modbus',
    bacnetProtocol: 'BACnet',
    opcUaProtocol: 'OPC UA',
    dataFormat: 'Data Format',
    dataFormatPlaceholder: 'Please select a data format',
    namePlaceholder: 'Please enter a gateway name',
    topicPlaceholder: 'Please enter a topic',
    identifierPlaceholder: 'Please enter an identifier',
    protocolPlaceholder: 'Please select a protocol',
    modbusTcpParameters: 'Modbus TCP Parameters',
    ipAddress: 'IP Address',
    ipAddressPlaceholder: 'Please enter an IP address',
    portPlaceholder: 'Please enter a port',
    pollIntervalSeconds: 'Poll Interval (seconds)',
    pollIntervalSecondsPlaceholder: 'Please enter the poll interval (seconds)',
    timeoutSeconds: 'Timeout (seconds)',
    timeoutSecondsPlaceholder: 'Please enter the timeout (seconds)',
    bacnetIpParameters: 'BACnet IP Parameters',
    targetAddress: 'Target Address',
    targetAddressPlaceholder: 'Please select a target address',
    targetPort: 'Target Port',
    targetPortPlaceholder: 'Please enter a target port',
    opcUaConnectionParameters: 'OPC UA Connection Parameters',
    opcUaEndpointPlaceholder: 'e.g. opc.tcp://192.168.1.100:4840',
    securityMode: 'Security Mode',
    securityModePlaceholder: 'Please select a security mode',
    securityPolicyUri: 'Security Policy URI',
    securityPolicyUriPlaceholder: 'Please enter a security policy URI',
    authType: 'Authentication Type',
    authTypePlaceholder: 'Please select an authentication type',
    usernamePlaceholder: 'Please enter a username',
    passwordPlaceholder: 'Please enter a password',
    serverAddressPlaceholder: 'Please enter a server address',
    requestTimeoutSecondsPlaceholder: 'Please enter the request timeout (seconds)',
    sessionTimeoutSeconds: 'Session Timeout (seconds)',
    sessionTimeoutSecondsPlaceholder: 'Please enter the session timeout (seconds)',
    connectionTimeoutSeconds: 'Connection Timeout (seconds)',
    connectionTimeoutSecondsPlaceholder: 'Please enter the connection timeout (seconds)',
    invalidIpAddress: 'Please enter a valid IP address',
    tokenRequestIncomplete: 'Enable dynamic token authentication and fill in both the request method and path',
    requestHeadersIncomplete: 'Request headers have incomplete rows; fill in both key and value or delete the row',
    requestBodyIncomplete: 'Request body has incomplete rows; fill in both key and value or delete the row',
    pollingRouteIncomplete: 'Polling pull requires both request method and path',
    routeGroupIncomplete: 'Polling pull / command dispatch has incomplete fields; fill in or clear the group',
    routeGroupRequired: 'At least one of polling pull or command dispatch must be filled in completely',
    tokenFieldRequiredWhenAuthEnabled: 'Token field name is required when authentication is enabled',
    tokenFieldRequiredWhenAuthDisabled: 'Token field name must be empty when authentication is disabled',
    selectTokenPlacement: 'Please select a token placement',
    autoFillTokenKeyPlaceholder: 'Auto-filled when the standard auth header is selected',
    spacePlaceholder: 'Please select a space',
    descriptionPlaceholder: 'Please enter a description',
    dynamicTokenAuth: 'Dynamic Token Authentication',
    tokenRequest: 'Token Request',
    contentType: 'Content Type',
    tokenFieldName: 'Token Field Name',
    expireFieldName: 'Expire Field Name',
    expireSeconds: 'Expire Seconds (seconds)',
    expireSecondsPlaceholder: 'Please enter expire seconds',
    deviceBehaviorRoute: 'Device Behavior Route',
    supportCommandSend: 'Support Command Dispatch',
    pollingPull: 'Polling Pull',
    requestMethodAndPath: 'Request Method and Path',
    ...
    dataExampleJson: 'Example Data JSON',
    copyExample: 'Copy Example',
    address: 'Address',
    path: 'Path',
    tokenAuth: 'Token Authentication',
    tokenRequestMethod: 'Token Request Method',
    tokenRequestPath: 'Token Request Path',
    pollRequestMethod: 'Poll Request Method',
    pollRequestPath: 'Poll Request Path',
    pollAuth: 'Poll Authentication',
    pollTokenPlacement: 'Poll Token Placement',
    pollTokenField: 'Poll Token Field',
    sendRequestMethod: 'Send Request Method',
    sendRequestPath: 'Send Request Path',
    sendAuth: 'Send Authentication',
    sendTokenPlacement: 'Send Token Placement',
    sendTokenField: 'Send Token Field',
    localAddress: 'Local Address',
    autoDiscovery: 'Auto Discovery',
    subscription: 'Subscription',
    protocolConfigEmpty: 'No protocol configuration',
    gatewayDetailEmpty: 'No gateway details'
  },
  deviceGroup: {
    management: 'Device Group Management',
    name: 'Group Name',
    namePlaceholder: 'Please enter a group name',
    parent: 'Parent Group',
    parentPlaceholder: 'Please select a parent group',
    description: 'Description',
    descriptionPlaceholder: 'Please enter a description',
  ...
  virtualPoint: {
    management: 'Virtual Point Management',
    action: {
      historyData: 'History Data',
      historyDisabled: 'History storage is not enabled',
      deleteConfirm: 'Are you sure you want to delete this virtual point?'
    },
    computeMode: {
      formula: 'Formula Calculation',
      threshold: 'Threshold Assignment',
      segmentMapping: 'Segment Mapping',
      statisticalCount: 'Statistic Count'
    },
    table: {
      name: 'Virtual Point Name',
      key: 'Virtual Point Identifier',
    ...
    drawer: {
      create: 'Create Virtual Point',
      edit: 'Edit Virtual Point',
      name: 'Virtual Point Name',
      key: 'Virtual Point Identifier',
      belongDevice: 'Belonging Device',
      belongDevicePlaceholder: 'Please select a device',
      status: 'Enabled Status',
      storageHistory: 'Store History Data',
      validTimeRange: 'Valid Time Range',
      computeMode: 'Compute Mode',
      configuration: 'Compute Configuration',
      settingJsonPlaceholder: 'Please enter virtual point setting JSON'
    },
    validation: {
      name: 'Please enter a virtual point name',
      key: 'Please enter a virtual point identifier',
      belongDevice: 'Please select a device',
      validTimeRangeRequired: 'Please add at least one valid time range',
      validTimeRangeInvalid: 'Valid time ranges must be within 0-23 and the start time cannot be after the end time',
      formulaRequired: 'Please edit the formula expression first',
      settingJsonInvalid: 'Compute configuration must be a valid JSON object',
      formulaFailed: 'Formula validation failed',
      switchMappingIncomplete: 'Please complete the switch mapping names',
      enumMappingIncomplete: 'Please complete the enum values and mapping names',
      enumValueDuplicate: 'Enum values cannot be duplicated'
    },
    history: {
      title: 'History Records',
      logicPointName: 'Logic Point Name',
      logicPointKey: 'Logic Point Identifier',
      stored: 'Stored',
      computeMode: 'Compute Mode',
      timeRange: 'Time Range',
      time: 'Time',
      reportedValue: 'Reported Value',
      missingPhysicalPointKey: 'Missing physical point identifier. History data cannot be fetched',
      fetchFailed: 'Failed to fetch history data'
    },
    setting: {
      title: 'Virtual Point Settings',
      dataType: 'Data Type',
      dataTypePlaceholder: 'Please select a data type',
      precision: 'Precision',
      precisionPlaceholder: 'Please select precision',
      unit: 'Unit',
      unitPlaceholder: 'Please select or enter a unit',
      trueAlias: 'Enabled Mapping Name',
      trueAliasPlaceholder: 'Please enter the enabled mapping name',
      falseAlias: 'Disabled Mapping Name',
      falseAliasPlaceholder: 'Please enter the disabled mapping name',
      enumMapping: 'Enum Mapping',
      enumValue: 'Enum Value',
      enumValuePlaceholder: 'Please enter an enum value',
      mappingName: 'Mapping Name',
      mappingNamePlaceholder: 'Please enter a mapping name'
    },
    formula: {
      title: 'Expression',
      validate: 'Validate Formula',
      validateSuccess: 'Formula validation passed',
      validateSuccessWithResult: 'Formula validation passed, result: {result}',
      clear: 'Clear',
      clearConfirm: 'Clear the current formula?',
      noContent: 'No formula content',
      pointSource: 'Point Source',
      selectDevice: 'Select Device',
      searchPoint: 'Search Points',
      noDigitalPoint: 'No digital points',
      keyboard: 'Calculator Keyboard'
    },
    formulaErrors: {
      invalidNumber: 'Please enter a valid number',
      functionAfterParen: 'A function must be followed by a left parenthesis',
      twoValuesNeedOperator: 'An operator is required between two values',
      rightParenBeforeValue: 'A right parenthesis must follow a value or point',
      parenMismatch: 'Parentheses do not match',
      consecutiveOperator: 'Operators cannot be used consecutively',
      logicalNotPosition: 'Logical NOT operator is in an invalid position',
      operatorAtStart: 'The expression cannot start with this operator',
      operatorBeforeValue: 'An operator must be preceded by a value, point, or right parenthesis',
      invalidContent: 'Invalid formula content',
      empty: 'Please add formula content',
      operatorAtEnd: 'The expression cannot end with an operator',
      openParenAfterFunction: 'A function must be followed by a left parenthesis',
      openParenAtEnd: 'The expression cannot end with a left parenthesis',
      unsupportedContent: 'The expression contains unsupported content',
      ternaryMismatch: 'Ternary expression is not balanced'
    },
    segmentMapping: {
      ...
      enableDefaultOutput: 'Enable Default Output',
      rules: 'Segment Rules',
      addRule: 'Add Segment',
      minValue: 'Min Value',
      maxValue: 'Max Value',
      bound: 'Boundary',
      boundLeftClosedRightOpen: 'Left-closed right-open [a, b)',
      boundClosedInterval: 'Closed interval [a, b]',
      boundOpenInterval: 'Open interval (a, b)',
      boundLeftOpenRightClosed: 'Left-open right-closed (a, b]',
      outputValue: 'Output Value',
      remark: 'Remark',
      deleteRule: 'Delete Segment',
      device: 'Device',
      devicePlaceholder: 'Please select a device',
      point: 'Point',
      pointPlaceholder: 'Please select a point',
      selectInitialPoint: 'Please select an initial point',
      completeRules: 'Please complete the segment rules, and the minimum value must be less than the maximum value',
      defaultOutputRequired: 'Please set a default output value'
    },
    thresholdAssign: {
      deviceSourceType: 'Device Source Type',
      action: 'Assignment Action',
      accumulateType: 'Accumulation Type',
      immediateAssign: 'Immediate Assign',
      window: 'Accumulation Window',
      assignRules: 'Assignment Rules',
      addRule: 'Add Rule',
      repeatTimes: 'Accumulation Count',
      duration: 'Duration',
      assignValue: 'Assign Value',
      deleteRule: 'Delete Rule',
      validationRulesRequired: 'Please add at least one assignment rule',
      device: 'Device',
      devicePlaceholder: 'Please select a device',
      deviceType: 'Device Type',
      ...
      minutes: 'Minutes',
      hours: 'Hours',
      validationWindow: 'The accumulation window must be a positive integer',
      validationValue: 'Please complete the assignment value',
      validationRepeatTimes: 'The accumulation count must be a positive integer',
      validationRepeatTimesDuplicate: 'Accumulation counts cannot be duplicated',
      validationDuration: 'Duration must be an integer greater than or equal to 0',
      validationDurationDuplicate: 'Durations cannot be duplicated',
      validationDurationExceedsWindow: 'Duration cannot exceed the accumulation window'
    },
    statisticalCount: {
      deviceSourceType: 'Device Source Type',
      settings: 'Statistics Settings',
      accumulateValue: 'Accumulated Value Per Hit',
      placeholder: 'Please enter an accumulated value',
      validationAccumulateValue: 'Accumulated value must be a positive integer'
    }
  },
  energy: {
    list: 'Energy List',
  ...
  messageRule: {
    management: 'Message Rule Management',
    name: 'Rule Name',
    gateway: 'Gateway',
    type: 'Rule Type',
    status: 'Status',
    ...
    enabled: 'Enabled',
    disabled: 'Disabled',
    add: 'Add Message Rule',
    edit: 'Edit Message Rule',
    view: 'View Message Rule',
    namePlaceholder: 'Please enter a rule name',
    gatewayPlaceholder: 'Please select a gateway',
    typePlaceholder: 'Please select a rule type',
    statusPlaceholder: 'Please select a status',
    scriptPlaceholder: 'Please enter script content',
    scriptLabel: 'Preprocessing Function (JavaScript):',
    testDataLabel: 'Test Data JSON:',
    validateScript: 'Validate Script',
    validateResultLabel: 'Validation Result:',
    invalidTestData: 'Test data must be valid JSON',
    format: 'Format',
    formatJsonError: 'Formatting failed. Please check JSON syntax',
    formatScriptError: 'Script formatting failed. Please check JavaScript syntax'
  },
  workorder: {
  ...
  route: {
    ...
    'device_device-group': 'Device Group Management',
      ...
      pointForm: {
        ...
        options: {
          ...
          units: {
            ...
            unit8: 'Megawatt',
            unit9: 'Kilowatt-hour',
            unit10: 'Megawatt-hour',
            unit11: 'Volt-ampere',
            unit12: 'Kilovolt-ampere',
            unit13: 'Volt-ampere reactive',
            unit14: 'Kilovolt-ampere reactive',
            unit15: 'Ohm',
            unit16: 'Milliohm',
            unit17: 'Kiloohm',
            unit18: 'Megohm',
            unit19: 'Power factor',
            unit20: 'Cubic meter/second',
            unit21: 'Cubic meter/minute',
            unit22: 'Cubic meter/hour',
            unit23: 'Liter/second',
            unit24: 'Liter/minute',
            unit25: 'Liter/hour',
            unit26: 'Cubic feet/minute',
            unit27: 'Cubic meter',
            unit28: 'Liter',
            unit29: 'Milliliter',
            unit30: 'Cubic foot',
            ...
            unit36: 'Inch',
            unit37: 'Meter/second',
            unit38: 'Kilometer/hour',
            unit39: 'Feet/minute',
            unit40: 'Hertz',
            unit41: 'Kilohertz',
            unit42: 'Revolutions/minute',
            unit43: 'Second',
            unit44: 'Millisecond',
            unit45: 'Minute',
            unit46: 'Hour',
            ...
            unit54: 'Foot-candle',
            unit55: 'Candela',
            unit56: 'Parts per million',
            unit57: 'Parts per billion',
            unit58: 'Milligram/liter',
            unit59: 'Milligram/cubic meter',
            unit60: 'Microgram/cubic meter',
            unit61: 'Joule',
            unit62: 'Kilojoule',
            unit63: 'Megajoule',
            unit64: 'Watt-hour',
            unit65: 'British thermal unit',
            unit66: 'Decibel',
            unit67: 'A-weighted decibel',
            unit68: 'pH value',
            unit69: 'Nephelometric turbidity unit',
            unit70: 'Percentage',
            unit71: 'Degree',
            unit72: 'Radian',
            unit73: 'No unit'
