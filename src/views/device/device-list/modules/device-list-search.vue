      ...
      <NCollapseItem :title="$t('common.search')" name="device-list-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="100">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi span="24 s:12 m:8" label="设备名称" path="name" class="pr-24px" label-width="auto">
              <NInput v-model:value="model.name" clearable placeholder="请输入设备名称" @keyup.enter="search" />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:8" label="设备标识" path="key" class="pr-24px" label-width="auto">
              <NInput v-model:value="model.key" clearable placeholder="请输入设备标识" @keyup.enter="search" />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:8" label="设备类型" path="device_type_id" class="pr-24px" label-width="auto">
              <RemoteSearchSelect
            ...
            <NFormItemGi span="24 s:12 m:8" label="设备组" path="device_group_id" class="pr-24px" label-width="auto">
              <NTreeSelect
