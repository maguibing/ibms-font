...
const searchParams = ref<Api.Alarm.AlarmRuleSearchParams>(createDefaultSearchParams());
...
function transformSearchParamsToRequest(params: Api.Alarm.AlarmRuleSearchParams): CommonType.CommonListQueryParams {
...
const { columns, columnChecks, data, extraData, getData, getDataByPage, loading, mobilePagination, scrollX } =
  useNaivePaginatedTable({
    api: () => fetchGetAlarmRuleList(transformSearchParamsToRequest(searchParams.value)),
...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    ...
    <NCard title="报警规则" :bordered="false" size="small" class="card-wrapper sm:flex-1-hidden">
