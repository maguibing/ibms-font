      ...
      <NCollapseItem :title="$t('common.search')" name="version-list-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="80">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi span="24 s:12 m:8" label="版本名称" path="name" class="pr-24px" label-width="auto">
              <NInput v-model:value="model.name" clearable placeholder="请输入版本名称" @keyup.enter="search" />
            </NFormItemGi>
